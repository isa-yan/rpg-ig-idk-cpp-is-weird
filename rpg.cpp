...
//scripts and global variables :p

    vector<string> intrograph = {
        "welcome to the world of 1920s Chicago", 
        "here you'll face gangs, mobsters, and crime. also a lot a alcohol",
